...
<html>
 ...
 <script type="text/javascript">
 	function validate(){
 			...
 			if(page > <s:property value="#request.listByAll.totalPage"/>){
 				...
 				window.document.location.href = "items_viewItemsByClass";
 				return false;
 			}
 			return true;
 	}
 ...
 <body>
        ...
        <s:else>
            <a href="items_viewItemsByClass">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="items_viewItemsByClass?page=<s:property value="#request.listByAll.currentPage - 1"/>">上一页</a>
        </s:else>
        
        <s:if test="#request.listByAll.currentPage != #request.listByAll.totalPage">
            <a href="items_viewItemsByClass?page=<s:property value="#request.listByAll.currentPage + 1"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a href="items_viewItemsByClass?page=<s:property value="#request.listByAll.totalPage"/>">尾页</a>
        </s:if>
